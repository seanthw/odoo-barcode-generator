...
class ProductTemplate(models.Model):
    ...
    def create(self, vals_list):
        """
        On creation of a template, this will also create variants,
        which will have their barcodes generated by their own create method.
        We still call generate_barcode() here to handle the case of a
        product created without variants.
        """
